...
async def upload_pdf(file: UploadFile = File(...)):
    ...
    try:
        ...
        if not text:
            ...
            raise HTTPException(status_code=400, detail="Could not extract text from PDF. It might be scanned or image-based.")
        ...
        print(f"vector_store set to: {vector_store}")
...
async def ask_question(data: QuestionRequest):
    ...
    print(f"In /ask, vector_store is: {vector_store}")
    if not vector_store:
